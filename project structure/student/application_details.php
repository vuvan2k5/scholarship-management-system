        ...
        <div class="ad-card-body">
          ...
          <?php else: ?>
            <div class="mb-3">
                ...
                <h3 class="fw-bold text-success mb-1"><?= number_format($disbursement['amount'], 0) ?> <span class="fs-6 text-muted fw-normal">VND</span></h3>
            </div>
            <div class="mb-3">
                ...
                ?>
                <span class="badge <?= $disbBadge ?> text-capitalize px-3 py-1.5"><?= e($disbursement['status']) ?></span>
            </div>
            <?php endif; ?>
            <?php if ($disbursement['disbursed_at']): ?>
                <div class="mb-3">
                    <label class="text-muted small d-block mb-1">Disbursed Date</label>
                    <strong class="text-dark"><?= date('F j, Y', strtotime($disbursement['disbursed_at'])) ?></strong>
                </div>
            <?php endif; ?>
            <?php if ($disbursement['note']): ?>
                <div>
                    <label class="text-muted small d-block mb-1">Notes</label>
                    <div class="p-2 bg-light rounded text-muted small" style="font-size: 11.5px;"><?= e($disbursement['note']) ?></div>
                </div>
          <?php endif; ?>
        </div>
      </div>
